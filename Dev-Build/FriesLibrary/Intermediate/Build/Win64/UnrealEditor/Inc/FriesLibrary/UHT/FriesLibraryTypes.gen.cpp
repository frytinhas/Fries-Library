...
template<> FRIESLIBRARY_API UScriptStruct* StaticStruct<FAllScalabilitys>()
{
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FAllScalabilitys_Statics::NewProp_AntiAliasing = { "AntiAliasing", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAllScalabilitys, AntiAliasing), Z_Construct_UEnum_FriesLibrary_EFlEngineScalabilityLevel, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAllScalabilitys_Statics::NewProp_AntiAliasing_MetaData), Z_Construct_UScriptStruct_FAllScalabilitys_Statics::NewProp_AntiAliasing_MetaData) }; // 1584941652
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FAllScalabilitys_Statics::NewProp_Shadows = { "Shadows", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAllScalabilitys, Shadows), Z_Construct_UEnum_FriesLibrary_EFlEngineScalabilityLevel, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAllScalabilitys_Statics::NewProp_Shadows_MetaData), Z_Construct_UScriptStruct_FAllScalabilitys_Statics::NewProp_Shadows_MetaData) }; // 1584941652
	...
	struct Z_CompiledInDeferFile_FID_Projetos_Separados__Unreal__MultiplayerShooter_Builds_FriesLibrary_HostProject_Plugins_FriesLibrary_Source_FriesLibrary_Public_FriesLibraryTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projetos_Separados__Unreal__MultiplayerShooter_Builds_FriesLibrary_HostProject_Plugins_FriesLibrary_Source_FriesLibrary_Public_FriesLibraryTypes_h_Statics::EnumInfo[] = {
		{ EGraphicsRHI_StaticEnum, TEXT("EGraphicsRHI"), &Z_Registration_Info_UEnum_EGraphicsRHI, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3656119270U) },
		{ EFlAmbientOcclusion_StaticEnum, TEXT("EFlAmbientOcclusion"), &Z_Registration_Info_UEnum_EFlAmbientOcclusion, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3426328814U) },
		{ EFlAntiAliasingMethod_StaticEnum, TEXT("EFlAntiAliasingMethod"), &Z_Registration_Info_UEnum_EFlAntiAliasingMethod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2837023146U) },
		{ EFlGlobalIlluminationMethod_StaticEnum, TEXT("EFlGlobalIlluminationMethod"), &Z_Registration_Info_UEnum_EFlGlobalIlluminationMethod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1570763377U) },
		{ EFlEngineScalabilityType_StaticEnum, TEXT("EFlEngineScalabilityType"), &Z_Registration_Info_UEnum_EFlEngineScalabilityType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2868424068U) },
		{ EFlEngineScalabilityLevel_StaticEnum, TEXT("EFlEngineScalabilityLevel"), &Z_Registration_Info_UEnum_EFlEngineScalabilityLevel, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1584941652U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projetos_Separados__Unreal__MultiplayerShooter_Builds_FriesLibrary_HostProject_Plugins_FriesLibrary_Source_FriesLibrary_Public_FriesLibraryTypes_h_Statics::ScriptStructInfo[] = {
		{ FAllScalabilitys::StaticStruct, Z_Construct_UScriptStruct_FAllScalabilitys_Statics::NewStructOps, TEXT("AllScalabilitys"), &Z_Registration_Info_UScriptStruct_AllScalabilitys, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAllScalabilitys), 778405464U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projetos_Separados__Unreal__MultiplayerShooter_Builds_FriesLibrary_HostProject_Plugins_FriesLibrary_Source_FriesLibrary_Public_FriesLibraryTypes_h_2677197294(TEXT("/Script/FriesLibrary"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Projetos_Separados__Unreal__MultiplayerShooter_Builds_FriesLibrary_HostProject_Plugins_FriesLibrary_Source_FriesLibrary_Public_FriesLibraryTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projetos_Separados__Unreal__MultiplayerShooter_Builds_FriesLibrary_HostProject_Plugins_FriesLibrary_Source_FriesLibrary_Public_FriesLibraryTypes_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Projetos_Separados__Unreal__MultiplayerShooter_Builds_FriesLibrary_HostProject_Plugins_FriesLibrary_Source_FriesLibrary_Public_FriesLibraryTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projetos_Separados__Unreal__MultiplayerShooter_Builds_FriesLibrary_HostProject_Plugins_FriesLibrary_Source_FriesLibrary_Public_FriesLibraryTypes_h_Statics::EnumInfo));
